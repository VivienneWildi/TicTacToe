const circleSymbol = '<ion-icon name="cloud-outline"></ion-icon>';
const crossSymbol = '<ion-icon name="flash-outline"></ion-icon>';
...
{
    document.getElementById( winningLine[0] ).style.backgroundColor = "lightblue";
    document.getElementById( winningLine[1] ).style.backgroundColor = "lightblue";
    document.getElementById( winningLine[2] ).style.backgroundColor = "lightblue";
}
...
function reset()
{
    ...
    document.getElementById("card").style.backgroundColor = "rgb(124, 161, 230)";
